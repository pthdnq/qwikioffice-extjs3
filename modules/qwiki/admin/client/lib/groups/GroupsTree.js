...
QoDesk.QoAdmin.GroupsTree = Ext.extend(Ext.tree.TreePanel, {
	...
	constructor : function(config){
		...
		function onLoad(){
			...
			this.root.on('expand',function(){ // +X+ ADDED to fix problem where root.children are not created until after root is expanded
				if(this.root.firstChild) this.selModel.select(this.root.firstChild);
			}, this, {delay:100});
		}
