...
class QoPreferences {
   ...
   public function viewThemes(){
      ...
      foreach($themes as $id => $theme){
         ...
         $item['pathtothumbnail'] = $theme_dir.$theme->thumbnail;
         $item['pathtofile'] = $theme_dir.$theme->file;
         $items[] = $item;
      }
    ...
    */
	public function viewWallpapers(){
      ...
      foreach($wallpapers as $id => $wallpaper){
         ...
         $item['pathtothumbnail'] = $wallpaper_dir.$wallpaper->thumbnail;
         $item['pathtofile'] = $wallpaper_dir.$wallpaper->file;
         $items[] = $item;
      }
