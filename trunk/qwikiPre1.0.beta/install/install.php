...
class install {
   ...
   public function begin(){
      // create the tables
      $commands = $this->get_create_commands();

      for($i = 0, $len = count($commands); $i < $len; $i++){
         if(!$this->create_table($commands[$i]['table'], $commands[$i]['command'])){
      ...
      // insert the data
      $commands = $this->get_insert_commands();

      for($i = 0, $len = count($commands); $i < $len; $i++){
         if(!$this->insert_data($commands[$i])){
            // return false on error
            return false;
         }
      }
    ...
    * get_create_commands()
    */
   private function get_create_commands(){
      $commands = array();

      $commands[] = array(
         'table' => 'qo_groups',
         'command' => "CREATE TABLE `qo_groups` (
      ...
      $commands[] = array(
         'table' => 'qo_groups_has_member_preferences',
         'command' => "CREATE TABLE `qo_groups_has_member_preferences` (
      ...
      $commands[] = array(
         'table' => 'qo_groups_has_members',
         'command' => "CREATE TABLE `qo_groups_has_members` (
            `qo_groups_id` int(11) unsigned NOT NULL default '0',
            `qo_members_id` int(11) unsigned NOT NULL default '0',
      ...
      $commands[] = array(
         'table' => 'qo_groups_has_privileges',
         'command' => "CREATE TABLE `qo_groups_has_privileges` (
         `qo_groups_id` int(11) unsigned NOT NULL default '0',
      ...
      $commands[] = array(
         'table' => 'qo_libraries',
         'command' => "CREATE TABLE `qo_libraries` (
      ...
      $commands[] = array(
         'table' => 'qo_members',
         'command' => "CREATE TABLE `qo_members` (
            `id` int(11) unsigned NOT NULL auto_increment,
      ...
      $commands[] = array(
         'table' => 'qo_modules',
         'command' => "CREATE TABLE `qo_modules` (
            `id` varchar(35) NOT NULL default '',
      ...
      $commands[] = array(
         'table' => 'qo_privileges',
         'command' => "CREATE TABLE `qo_privileges` (
            `id` int(11) unsigned NOT NULL auto_increment,
            `data` text COMMENT 'The definition data ( JSON )',
            `active` tinyint(1) unsigned NOT NULL default '0' COMMENT 'A value of 1 or 0 is expected',
            PRIMARY KEY  (`id`));"
      ...
      $commands[] = array(
         'table' => 'qo_sessions',
         'command' => "CREATE TABLE `qo_sessions` (
      ...
      $commands[] = array(
         'table' => 'qo_signup_requests',
         'command' => "CREATE TABLE `qo_signup_requests` (
            `id` int(11) unsigned NOT NULL auto_increment,
            `first_name` varchar(25) default NULL,
            `last_name` varchar(35) default NULL,
            `email_address` varchar(55) default NULL,
      ...
      $commands[] = array(
         'table' => 'qo_themes',
         'command' => "CREATE TABLE `qo_themes` (
            `id` varchar(35) NOT NULL default '',
            `data` text COMMENT 'The definition data ( JSON )',
            `active` tinyint(1) unsigned NOT NULL default '0' COMMENT 'A value of 1 or 0 is expected',
            PRIMARY KEY  (`id`));"
      ...
      $commands[] = array(
         'table' => 'qo_wallpapers',
         'command' => "CREATE TABLE `qo_wallpapers` (
            `id` int(11) unsigned NOT NULL auto_increment,
            `data` text COMMENT 'The definition data ( JSON )',
            `active` tinyint(1) unsigned NOT NULL default '0' COMMENT 'A value of 1 or 0 is expected',
            PRIMARY KEY  (`id`));"
      ...
      return $commands;
   } // end get_create_commands()

   /**
    * create_table() Creates database table if it does not already exist.
    *
   ...
   private function table_exists($table_name){
      $result = $this->os->db->conn->query('SHOW TABLES');
      if($result){
