...
class preference {
   ...
   private function add($member_id, $group_id, $data){
      ...
      $sql = "INSERT INTO qo_groups_has_member_preferences (qo_groups_id, qo_members_id, data ) VALUES (?, ?, ?)";
   ...
   private function update($member_id, $group_id, $data){
      ...
      $sql = "UPDATE qo_groups_has_member_preferences SET data = ? WHERE qo_groups_id = ? AND qo_members_id = ?";
